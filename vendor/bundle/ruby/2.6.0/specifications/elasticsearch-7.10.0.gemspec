# -*- encoding: utf-8 -*-
# stub: elasticsearch 7.10.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<elasticsearch-transport>.freeze, ["= 7.10.0"])
    s.add_runtime_dependency(%q<elasticsearch-api>.freeze, ["= 7.10.0"])
    ...
    s.add_dependency(%q<elasticsearch-transport>.freeze, ["= 7.10.0"])
    s.add_dependency(%q<elasticsearch-api>.freeze, ["= 7.10.0"])
